<template class="desktop">
  <v-col cols="12" lg="9" offset-lg="3">
    <v-row class="ml-12" align-content="space-around">
      <v-col lg="7" md="8" class="ma-0 mr-12 text-left">
        <p>
      ...
      <v-col lg="4" md="3" @click="showGallery">
        <v-hover>
      ...
      <v-col lg="7" md="8" class="mt-6 ml-lg-12">
