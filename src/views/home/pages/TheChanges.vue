    ...
    <v-main class="mt-12">
      <v-row class="mt-12">
        ...
        <v-col cols="10" lg="8" sm="10" class="mt-12 text-justify">
          <p :class="{'display-1': $vuetify.breakpoint.lgAndUp, 'headline': $vuetify.breakpoint.mdAndDown}">Taxonomic and Nomenclatural Changes</p>
          <v-divider></v-divider>
        </v-col>
      </v-row>
      <v-row no-gutters>
...
export default {
  ...
  data() {
    return {
      title: 'Taxonomic & Nomenclatural Changes',
    };
  },
};
</script>
